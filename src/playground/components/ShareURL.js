                ...
                <div className="share-url-wrapper">
                    <div className="share-url">
                        ...
                        >
                            ...
                            <svg width="20" height="20" viewBox="0 0 20 20" className="c-icon" role="img" aria-label="copy" fill="none" focusable="false">
                    ...
                    {isDataCopied && (
                        <span id="share-url__announcement" className="share-url__announcement" aria-live="polite" aria-atomic="true">
                            Copied to clipboard.
                        </span>
                    )}
                </div>
